...
<body style=" background:  #afefd4;">
	...
	<div class="login-container bg-light">
		...
		<form action="userdetails" method="post">
			...
			<%-- <div class="mb-3">
						<label for="therapy" class="form-label fw-bold">Select
							Therapy:</label> <select class="form-control" name="therapyname"
							id="therapy" required>
			...
			<div class="container">
				<div class="text-center" style="display: flex;">
					<button type="submit" style="width: 40%;"
						class="btn btn-primary btn-lg m-3">Register</button>
